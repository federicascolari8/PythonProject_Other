...
class StaticPlotter:
    ...
    def cum_plotter(self, output):
        """
        Method to plot the cumulative grain size distribution curve and save it as an image
        :param output: name of the image containing the plot
        :return: None
        """
    ...
    def __set_axis_colour_and_format(self, ax):
        """
        Private method which sets the plot properties
        :param ax: main secondary axis
        :return: None
        """
